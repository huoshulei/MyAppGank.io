...
import com.example.huo.myappgankio.ui.fragment.AndroidFragment;
import com.example.huo.myappgankio.adapter.DrawerAdapter;
...
//                    .getMenuTitle());
            if (mAdapter.getItem(position).getMenuTitle().equals("福利")) {
